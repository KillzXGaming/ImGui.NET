...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        public static bool CheckboxFlags(string label, ref long flags, long flags_value)
        {
            ...
            {
                byte ret = ImGuiNative.igCheckboxFlagsS64Ptr(native_label, native_flags, flags_value);
                if (label_byteCount > Util.StackAllocationSizeLimit)
                {
                    Util.Free(native_label);
                }
        ...
        public static bool CheckboxFlags(string label, ref ulong flags, ulong flags_value)
        {
            ...
            {
                byte ret = ImGuiNative.igCheckboxFlagsU64Ptr(native_label, native_flags, flags_value);
                if (label_byteCount > Util.StackAllocationSizeLimit)
                {
                    Util.Free(native_label);
                }
        ...
        public static void DockContextClearNodes(ImGuiContextPtr ctx, uint root_id, bool clear_settings_refs)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            byte native_clear_settings_refs = clear_settings_refs ? (byte)1 : (byte)0;
            ImGuiNative.igDockContextClearNodes(native_ctx, root_id, native_clear_settings_refs);
        }
        public static uint DockContextGenNodeID(ImGuiContextPtr ctx)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            uint ret = ImGuiNative.igDockContextGenNodeID(native_ctx);
            return ret;
        }
        public static void DockContextInitialize(ImGuiContextPtr ctx)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            ImGuiNative.igDockContextInitialize(native_ctx);
        }
        public static void DockContextNewFrameUpdateDocking(ImGuiContextPtr ctx)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            ImGuiNative.igDockContextNewFrameUpdateDocking(native_ctx);
        }
        public static void DockContextNewFrameUpdateUndocking(ImGuiContextPtr ctx)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            ImGuiNative.igDockContextNewFrameUpdateUndocking(native_ctx);
        }
        public static void DockContextQueueDock(ImGuiContextPtr ctx, ImGuiWindowPtr target, ImGuiDockNodePtr target_node, ImGuiWindowPtr payload, ImGuiDir split_dir, float split_ratio, bool split_outer)
        {
            ...
            ImGuiWindow* native_payload = payload.NativePtr;
            byte native_split_outer = split_outer ? (byte)1 : (byte)0;
            ImGuiNative.igDockContextQueueDock(native_ctx, native_target, native_target_node, native_payload, split_dir, split_ratio, native_split_outer);
        }
        public static void DockContextQueueUndockNode(ImGuiContextPtr ctx, ImGuiDockNodePtr node)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            ImGuiDockNode* native_node = node.NativePtr;
            ImGuiNative.igDockContextQueueUndockNode(native_ctx, native_node);
        }
        public static void DockContextQueueUndockWindow(ImGuiContextPtr ctx, ImGuiWindowPtr window)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            ImGuiWindow* native_window = window.NativePtr;
            ImGuiNative.igDockContextQueueUndockWindow(native_ctx, native_window);
        }
        public static void DockContextRebuildNodes(ImGuiContextPtr ctx)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            ImGuiNative.igDockContextRebuildNodes(native_ctx);
        }
        public static void DockContextShutdown(ImGuiContextPtr ctx)
        {
            ImGuiContext* native_ctx = ctx.NativePtr;
            ImGuiNative.igDockContextShutdown(native_ctx);
        }
        ...
        {
            ImGuiItemFlags ret = ImGuiNative.igGetItemsFlags();
            return ret;
        }
        ...
        public static ImRect GetWindowAllowedExtentRect(ImGuiWindowPtr window)
        {
            ImRect __retval;
            ImGuiWindow* native_window = window.NativePtr;
            ImGuiNative.igGetWindowAllowedExtentRect(&__retval, native_window);
            return __retval;
        }
        ...
        {
            float ret = ImGuiNative.igImAbsFloat(x);
            return ret;
        }
        public static double ImAbs(double x)
        {
            double ret = ImGuiNative.igImAbsdouble(x);
            return ret;
        }
        ...
        {
            float ret = ImGuiNative.igImFloorFloat(f);
            return ret;
        }
        public static Vector2 ImFloor(Vector2 v)
        {
            Vector2 __retval;
            ImGuiNative.igImFloorVec2(&__retval, v);
            return __retval;
        }
        ...
        {
            byte ret = ImGuiNative.igImIsPowerOfTwoInt(v);
            return ret != 0;
        }
        public static bool ImIsPowerOfTwo(ulong v)
        {
            byte ret = ImGuiNative.igImIsPowerOfTwoU64(v);
            return ret != 0;
        }
        ...
        {
            Vector2 __retval;
            ImGuiNative.igImLerpVec2Float(&__retval, a, b, t);
            return __retval;
        }
        public static Vector2 ImLerp(Vector2 a, Vector2 b, Vector2 t)
        {
            Vector2 __retval;
            ImGuiNative.igImLerpVec2Vec2(&__retval, a, b, t);
            return __retval;
        }
        public static Vector4 ImLerp(Vector4 a, Vector4 b, float t)
        {
            Vector4 __retval;
            ImGuiNative.igImLerpVec4(&__retval, a, b, t);
            return __retval;
        }
        ...
        {
            float ret = ImGuiNative.igImLogFloat(x);
            return ret;
        }
        public static double ImLog(double x)
        {
            double ret = ImGuiNative.igImLogdouble(x);
            return ret;
        }
        ...
        {
            float ret = ImGuiNative.igImSignFloat(x);
            return ret;
        }
        public static double ImSign(double x)
        {
            double ret = ImGuiNative.igImSigndouble(x);
            return ret;
        }
        ...
        public static bool InputTextEx(string label, string hint, string buf, int buf_size, Vector2 size_arg, ImGuiInputTextFlags flags, IntPtr callback)
        {
            byte* native_label;
            int label_byteCount = 0;
            if (label != null)
        ...
        public static bool InputTextEx(string label, string hint, string buf, int buf_size, Vector2 size_arg, ImGuiInputTextFlags flags, IntPtr callback, IntPtr user_data)
        {
            byte* native_label;
            int label_byteCount = 0;
            if (label != null)
        ...
        {
            byte ret = ImGuiNative.igIsPopupOpenID(id, popup_flags);
            return ret != 0;
        }
        ...
        {
            Vector2 size_arg = new Vector2(-float.MinValue, 0);
        ...
        {
            ImGuiWindow* native_window = window.NativePtr;
            ImGuiNative.igSetScrollXWindowPtr(native_window, scroll_x);
        }
        ...
        {
            ImGuiWindow* native_window = window.NativePtr;
            ImGuiNative.igSetScrollYWindowPtr(native_window, scroll_y);
        }
        ...
        public static void TabBarQueueReorder(ImGuiTabBarPtr tab_bar, ImGuiTabItemPtr tab, int dir)
        {
            ImGuiTabBar* native_tab_bar = tab_bar.NativePtr;
            ImGuiTabItem* native_tab = tab.NativePtr;
            ImGuiNative.igTabBarQueueReorder(native_tab_bar, native_tab, dir);
        }
        ...
        {
            ImGuiTable* native_table = table.NativePtr;
            ImGuiNative.igTableGcCompactTransientBuffers(native_table);
        }
        ...
        {
            ImGuiTable* native_table = table.NativePtr;
            byte* ret = ImGuiNative.igTableGetColumnNameTablePtr(native_table, column_n);
            return Util.StringFromPtr(ret);
        }
        ...
        {
            byte native_enabled = enabled ? (byte)1 : (byte)0;
            ImGuiNative.igTableSetColumnEnabled(column_n, native_enabled);
        }
