...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        public static bool InputText(
            ...
            uint buf_size)
        {
            return InputText(label, buf, buf_size, 0, IntPtr.Zero, IntPtr.Zero);
        }
        ...
        {
            return InputText(label, buf, buf_size, flags, IntPtr.Zero, IntPtr.Zero);
        }
        ...
        public static bool InputText(
            string label,
            ref string input,
            uint maxLength) => InputText(label, ref input, maxLength, 0, IntPtr.Zero, IntPtr.Zero);

        public static bool InputText(
            string label,
            ref string input,
            uint maxLength,
            ImGuiInputTextFlags flags) => InputText(label, ref input, maxLength, flags, IntPtr.Zero, IntPtr.Zero);
        ...
        public static bool InputText(
            ...
            uint maxLength,
            ImGuiInputTextFlags flags,
            IntPtr callback) => InputText(label, ref input, maxLength, flags, callback, IntPtr.Zero);
        ...
        public static bool InputTextMultiline(
            ...
            ref string input,
            uint maxLength,
            Vector2 size) => InputTextMultiline(label, ref input, maxLength, size, 0, IntPtr.Zero, IntPtr.Zero);
        ...
        public static bool InputTextMultiline(
            ...
            uint maxLength,
            Vector2 size,
            ImGuiInputTextFlags flags) => InputTextMultiline(label, ref input, maxLength, size, flags, IntPtr.Zero, IntPtr.Zero);
        ...
        public static bool InputTextMultiline(
            ...
            Vector2 size,
            ImGuiInputTextFlags flags,
            IntPtr callback) => InputTextMultiline(label, ref input, maxLength, size, flags, callback, IntPtr.Zero);
